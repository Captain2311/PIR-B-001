...
def stop_rolling_motors(): 
    global rolling_effort
    rolling_effort = 0.0
    rospy.loginfo(f"Stopping rolling motors")
    
if __name__ == "__main__":
    settings = termios.tcgetattr(sys.stdin)

    rospy.init_node('teleop_cv')
    ...
    a   s   d           d/a: roll cw/ ccw 
      z   x             s/z: stop all motors/ stop rolling motors
